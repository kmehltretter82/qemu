 ...
 * keyboard interface (stubbed) and the memory/timing control
 * registers (storage only). DMA channels are not implemented.
 *
...
#define IOMD_KARTTX     0x004   /* read: KARTRX */
