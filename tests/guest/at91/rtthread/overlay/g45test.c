...
static const struct g45test_case g45test_cases[] = {
    ...
    { "d1.arbitration", "d1", "D1", g45test_d1_arbitration },
    { "d1.boundary-overlap", "d1", "D1",
      g45test_d1_boundary_overlap },
    { "d1.linked-list", "d1", "D1", g45test_d1_linked_list },
    { "d1.descriptor-auto-boundary", "d1", "D1",
      g45test_d1_descriptor_auto_boundary },
    { "d1.live-descriptor-update", "d1", "D1",
      g45test_d1_live_descriptor_update },
    ...
    { "d1.auto-replay", "d1", "D1", g45test_d1_auto_replay },
    ...
    { "irq.tc-oneshot", "irq", "IRQ", g45test_irq_tc_oneshot },
